...
import 'package:kidzworld/drawingboard/drawing_canvash/widgets/color_palette.dart';
...
class CanvasSideBar extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 100,
      height: MediaQuery.of(context).size.height < 680 ? 500 : 600,
        ...
        child: SizedBox(
          ...
          child: Tooltip(
            ...
            child: child ??
                Icon(
                  iconData,
                  color: selected ? Colors.amber[900] : Colors.grey,
                  size: 20,
                ),
          ),
        ),
